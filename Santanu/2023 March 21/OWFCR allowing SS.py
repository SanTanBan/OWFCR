...
Excel_Filename="Dashboard_Input.xlsx"
...
OWFCR_SS=int(Decisions['OWFCR-SS'])
...
if Solutions_Found:
    ...
    plt.title("Objective Value "+str(round(objec_val))+" found in "+str(round(run_time))+" seconds using Gurobi 10.0")
    plt.ylabel("Latitude")
    plt.xlabel("Longitude")    
    name="Off-Shore Wind Farm Cable Routing.jpg"
    plt.savefig(format(name),format='jpg',bbox_inches="tight")
